                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control"
                                                   ...
                                                   id="answer1" aria-describedby="choice1Help" placeholder="Enter Choice 1">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control"
                                                   ...
                                                   id="answer2" aria-describedby="choice1Help" placeholder="Enter Choice 2">
                                            <small id="answer1Help" class="form-text text-muted"></small>
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control"
                                                   ...
                                                   id="answer3" aria-describedby="choice1Help" placeholder="Enter Choice 3">
                                    ...
                                    <div>
                                        <div class="form-group">
                                            ...
                                            <input name="answers[][answer]" type="text" class="form-control"
                                                   ...
                                                   id="answer4" aria-describedby="choice1Help" placeholder="Enter Choice 4">
